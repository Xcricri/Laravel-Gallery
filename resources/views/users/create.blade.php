        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('users.store') }}" method="post" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        {{-- div for name --}}
                        <div>
                            <div class="flex">
                        ...
                        <div>
                            ...
                            <x-text-input id="avatar" class="mt-1 block w-full" name="avatar" :value="old('avatar')" type="file"/>
                        ...
                        <div>
                            ...
                            <select name="role" id="role" class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1">
                                <option value=""></option>
                                <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin</option>
                                <option value="member" {{ old('role') == 'member' ? 'selected' : '' }}>Member</option>
                            </select>
                            <x-input-error :messages="$errors->addUser->get('role')" class="mt-2"/>
                        </div>
                        {{-- div for email --}}
                        <div>
                            <div class="flex">
                            ...
                            <x-text-input id="email" class="mt-1 block w-full" name="email" :value="old('email')" type="email"/>
